...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', type=str, help='path to output dir', 
                        default='/c1/kangsan/Painter/datasets/ap10k')
...
if __name__ == "__main__":
    ...
    save_path = os.path.join(args.output_dir, "ap10k_pose_256x192_{}.json".format(split))
    print(save_path)

    output_dict = []

    for aug_idx in aug_list:
        image_dir = "/c1/kangsan/Painter/datasets/ap10k/data_pair/{}_256x192{}".format(split, aug_idx)
        ...
        for image_path in tqdm.tqdm(image_path_list):
            ...
            if not os.path.isfile(label_path):
                ...
                continue
            pair_dict = {}
            pair_dict["image_path"] = image_path.replace('/c1/kangsan/Painter/datasets/', '')
            pair_dict["target_path"] = label_path.replace('/c1/kangsan/Painter/datasets/', '')
