...
train_pipeline = [
    ...
    dict(
        ...
        dir_name='train_org',
        target_path='/c1/kangsan/Painter/datasets/livecell/pano_ca_inst',
...
data_root = '/c1/kangsan/Painter/datasets/livecell/'
data = dict(
    samples_per_gpu=8,
    workers_per_gpu=8,
    train=dict(
        ...
        seg_prefix=data_root+'images/pano_sem_seg/panoptic_segm_train_with_color',
        pipeline=train_pipeline,
        ann_file=data_root + 'livecell_coco_train.json',
    ),
    val=dict(
        type='CocoDataset',
        img_prefix=data_root+'images/livecell_train_val_images',
        pipeline=test_pipeline,
        ins_ann_file=data_root + 'livecell_coco_val.json',
        ann_file=data_root + 'livecell_coco_val.json',
    ),
    test=dict(
        type='CocoDataset',
        img_prefix=data_root+'images/livecell_test_images',
        pipeline=test_pipeline,
        ins_ann_file=data_root + 'livecell_coco_test.json',
        ann_file=data_root + 'livecell_coco_test.json',
    ))
