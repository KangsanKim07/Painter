...
class Painter(nn.Module):
    ...
    def forward_encoder(self, imgs, tgts, bool_masked_pos, merge_between_batch=-1):
        # embed patches
    ...
    def forward(self, imgs, tgts, bool_masked_pos=None, valid=None, merge_between_batch=-1):
        # imgs = imgs.squeeze(0)
        # tgts = tgts.squeeze(0)
        # bool_masked_pos = bool_masked_pos.squeeze(0)
        ...
        latent = self.forward_encoder(imgs, tgts, bool_masked_pos, merge_between_batch=merge_between_batch)
...
def painter_vit_large_patch16_input896x448_win_dec64_8glb_sl1(**kwargs):
    model = Painter(
        ...
        residual_block_indexes=[], use_rel_pos=True, out_feature="last_feat", use_act_checkpoint=True,
