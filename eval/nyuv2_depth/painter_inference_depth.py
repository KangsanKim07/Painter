...
if __name__ == '__main__':
    ...
    dst_dir = os.path.join('/c1/kangsan/Painter/models_inference',
                           "nyuv2_depth_inference/")
    print(dst_dir)
    if not os.path.exists(dst_dir):
        os.makedirs(dst_dir)

    img_src_dir = "/c1/kangsan/Painter/toy_datasets/nyu_depth_v2/official_splits/test/"
    img_path_list = glob.glob(img_src_dir + "/*/rgb*g")
    img2_path = "/c1/kangsan/Painter/toy_datasets/nyu_depth_v2/sync/{}.jpg".format(args.prompt)
    tgt_path = "/c1/kangsan/Painter/toy_datasets/nyu_depth_v2/sync/{}.png".format(args.prompt.replace('rgb', 'sync_depth'))
    tgt2_path = tgt_path
