...
def get_args_parser():
    ...
    parser.add_argument('--dist_type', type=str, help='color type',
                        default='mean', choices=['abs', 'square', 'mean'])
...
if __name__ == '__main__':
    ...
    dataset_name = 'voc2012_val_sem_seg'
    pred_dir = args.pred_dir
    suffix = args.suffix
    output_folder = os.path.join(pred_dir, 'eval_voc2012_{}'.format(suffix))

    from data.voc2012.gen_color_voc2012_sem import define_colors_per_location_mean_sep
