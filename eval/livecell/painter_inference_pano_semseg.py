...
if __name__ == '__main__':
    ...
    model = args.model
    prompt = 'A172_Phase_A7_1_00d00h00m_2'
    ...
    dst_dir = os.path.join('/c1/kangsan/Painter/models_inference',
                           "livecell_pano_semseg_inference_{}_{}_size{}/".format(ckpt_file, prompt, input_size))
    ...
    img_src_dir = dataset_dir + "livecell/images/livecell_train_val_images"
    dataset_val = DatasetTest(img_src_dir, input_size, ext_list=('*.tif',))
    ...
    # img2_path = dataset_dir + "livecell/images/livecell_train_val_images/{}.tif".format(prompt)
    # tgt2_path = dataset_dir + "livecell/pano_sem_seg/panoptic_segm_train_with_color/{}.png".format(prompt)
    
    examples = [x.split('.')[0] for x in os.listdir(dataset_dir + "livecell/images/livecell_train_val_images")]
    img2_paths = []
    tgt2_paths = []
    for example in examples[:2]:
        img2_paths.append(dataset_dir + "livecell/images/livecell_train_val_images/{}.tif".format(example))
        tgt2_paths.append(dataset_dir + "livecell/pano_sem_seg/panoptic_segm_train_with_color/{}.png".format(example))
    ...
    for data in tqdm.tqdm(data_loader_val):
        ...
        out_path = os.path.join(dst_dir, img_name.replace('.tif', '.png'))
